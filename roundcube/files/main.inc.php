...
$rcmail_config['default_host'] = '{{ server.mail.host }}';
...
// For example %n = mail.domain.tld, %t = domain.tld
$rcmail_config['smtp_server'] = '{{ server.mail.host }}';
...
$rcmail_config['force_https'] = {{ server.force_https }};
...
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$rcmail_config['default_folders'] = array('INBOX', 'Drafts', 'Sent', 'Junk', 'Trash'{% if "archive" in server.plugins %}, 'Archive'{% endif %});
